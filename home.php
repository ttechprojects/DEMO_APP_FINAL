...
<body onload="openViewModal2()">
    ...
    //change the html code here for visuals and stuff
        echo "<div id='room-view' class='container-fluid'>"; //creating a division to hold the table.
...
<div id="visualization" class="hidden"></div>
   </div>
...
<script type="text/javascript">
  ...
  $.ajax({
    ...
    zoomMax: 1000 * 60 * 60,  //milliseconds unit
    format: {
      minorLabels: {
        hour: 'h:mm A'
      }
